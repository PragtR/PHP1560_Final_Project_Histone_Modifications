...
#' 
#' @description plots barplots for a given metric for the cross evaluated model
#' 
...
#' 
#' @return nothing to return, but plots barplots of the metric for each test chromosome
